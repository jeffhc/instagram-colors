...
def load_photos(array):
	...
	for filepath in array:
		...
		if rgb_data.shape == (640, 640, 3):
			...
			print("IMAGE IS BLACK AND WHITE")
...
if isdir('project_checkpoint'):
	saver.restore(sess, "./project_checkpoint_4/checkpoint-715")
...
#new_file_names = new_file_names[:2000]
#print(len(new_file_names))

for epoch in range(100000):

	for train_images, train_likes in zip(chunks(new_file_names, BATCH_SIZE, 'images'), chunks(new_file_names, BATCH_SIZE, 'likes')):
